import mushyswapList from "../mushyswap.token-list.json";
import mushyswapExperimentalList from "../mushyswap-experimental.token-list.json";
...
export const defaultList: TokenList = mushyswapList;
export const experimental: TokenList = mushyswapExperimentalList;
